...
function handleMeta (node, type) {
  ...
  if (!meta.language) {
    if (node['@'] && node['@']['xml:lang']) meta.language = getValue(node['@'], 'xml:lang');
  ...
  if (!meta.copyright) {
    if (node['media:copyright']) meta.copyright = getValue(node['media:copyright']);
      ...
      if (Array.isArray(node['cc:license']) && node['cc:license'][0]['@'] && node['cc:license'][0]['@']['rdf:resource']) {
        meta.copyright = getValue(node['cc:license'][0]['@'], 'rdf:resource');
      } else if (node['cc:license']['@'] && node['cc:license']['@']['rdf:resource']) {
        meta.copyright = getValue(node['cc:license']['@'], 'rdf:resource');
      }
    }
  }
  if (!meta.generator) {
    if (node['admin:generatoragent']) {
      if (Array.isArray(node['admin:generatoragent']) && node['admin:generatoragent'][0]['@'] && node['admin:generatoragent'][0]['@']['rdf:resource']) {
        meta.generator = getValue(node['admin:generatoragent'][0]['@'], 'rdf:resource');
      } else if (node['admin:generatoragent']['@'] && node['admin:generatoragent']['@']['rdf:resource']) {
        meta.generator = getValue(node['admin:generatoragent']['@'], 'rdf:resource');
      }
    }
  }
